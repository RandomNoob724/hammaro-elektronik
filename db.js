...
exports.addStaffMemeber = function(staffValues ,callback){
    const query = "INSERT INTO staff (firstName, lastName) VALUES (?,?,?)"
    const values = [staffValues.firstName, staffValues.lastName]
...
exports.getStaffByName = function(staffValues, callback){
